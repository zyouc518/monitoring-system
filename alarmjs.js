$(document).ready(function () {
    $.ajaxSetup({
        ...
        var TML=3;
            ...
            var alarm2strain=0;
            var waterflag=0;
            if (aar[0]>20){waterflag++;}
            if (aar2[0]>20){waterflag++;}
            if (aar3[0]>20){waterflag++;}
            if (aar4[0]>20){waterflag++;}
            if (aar5[0]>20){waterflag++;}
            if (aar6[0]>20){waterflag++;}
            if ((waterflag/6)>0.75)
            {
                alarm2water=1;
            }
            ...
            var pressurealarm=0;
            if (((aar[0]-aar[1])/aar[1])>0.25){pressurealarm++;}
            if (((aar2[0]-aar2[1])/aar2[1])>0.25){pressurealarm++;}
            if (((aar3[0]-aar3[1])/aar3[1])>0.25){pressurealarm++;}
            if (((aar4[0]-aar4[1])/aar4[1])>0.25){pressurealarm++;}
            if (((aar5[0]-aar5[1])/aar5[1])>0.25){pressurealarm++;}
            if (((aar6[0]-aar6[1])/aar6[1])>0.25){pressurealarm++;}
            ...
            var strainalarm=0;
            if (((aaar[0]-aaar[1])/aaar[1])>0.2){strainalarm++;}
            if (((aaar2[0]-aaar2[1])/aaar2[1])>0.2){strainalarm++;}
            if (((aaar3[0]-aaar3[1])/aaar3[1])>0.2){strainalarm++;}
            if (((aaar4[0]-aaar4[1])/aaar4[1])>0.2){strainalarm++;}
            if (((aaar5[0]-aaar5[1])/aaar5[1])>0.2){strainalarm++;}
            if (((aaar6[0]-aaar6[1])/aaar6[1])>0.2){strainalarm++;}
